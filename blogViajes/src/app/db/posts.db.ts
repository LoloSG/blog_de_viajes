...
export const POSTS: PostBlog[] = [
    ...
    {
        id: 2,
        titulo: 'La Golden Week: disfruta de unos días únicos en Tokio, Japón',
        texto: 'La Golden Week o Semana Dorada es el mayor periodo vacacional de Japón. Esto se debe a la acumulación de días festivos, todos de carácter nacional, que conmemoran diferentes hitos históricos y celebran días importantes para la ciudadanía. Durante estos días, la actividad en el país se frena de manera reseñable para ofrecer a sus habitantes unos días de vacaciones tras meses de trabajo. Es que, aunque los estudiantes japoneses sí cuentan con períodos largos de descanso, la mayoría de los trabajadores rara vez consiguen varios días seguidos para descansar o disfrutar de su tiempo libre.',
        autor: 'Mary Popper',
